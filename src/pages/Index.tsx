        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 rounded-3xl overflow-hidden border border-clay/20 shadow-sm" style={{ height: "420px" }}>
              <img
                src="https://cdn.poehali.dev/projects/9110f643-73a0-48e7-bd16-82bb950d8c0a/bucket/1b0a879d-29ea-4e44-abf3-9bad72e51e1d.jpg"
                alt="Маршрут от метро Площадь Ленина до Потанинской 6"
                className="w-full h-full object-cover object-top"
              />
            </div>
